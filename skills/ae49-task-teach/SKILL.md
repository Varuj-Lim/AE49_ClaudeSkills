...
> *Adapted from [mattpocock/skills — productivity/teach](https://github.com/mattpocock/skills/tree/main/skills/productivity/teach) by Matt Pocock ([MIT License](https://github.com/mattpocock/skills/blob/main/LICENSE)).*
...
Write lessons in plain language first — define any technical term the moment it's first used rather than assuming the reader already knows it. Jargon is fine once it's been introduced this way, but never assumed.
