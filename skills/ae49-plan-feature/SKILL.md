...
description: >
  ...
  when the user wants to plan or design a new feature, invokes /ae49-plan-feature,
...
3. **Grill the design.** Invoke the **ae49-grill** skill (via the Skill tool) on
...
- Session left back in plan mode, ready for the next `/ae49-plan-feature`.
